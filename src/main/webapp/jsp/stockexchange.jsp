...
<form:form method="POST" action="/stockExchangeInsert" modelAttribute="stockExchange" class="loginform">
 <!-- <h2 style="text-align: center;">SIGNUP</h2>--><br><br> 
 
<%--  <div class="row">
            <div class="form-group col-md-12">
               <label class="col-md-2 " for="stockexchange_id">stockexchange Id:</label>
               <div class="col-md-6">
                    <form:input type="text" path="stockexchange_id" id="stockexchange_id"  class="form-control input-sm"/>
                    <div class="has-error">
                        <form:errors path="stockexchange_id" class="text-danger"/>
                    </div>
                </div>
            </div>
        </div> --%>
	...
	<div class="row">
            <div class="form-group col-md-12">
               ...
               <div class="col-md-6">
                    <form:input type="text" path="stockExchangeName" id="stockExchangeName"  class="form-control input-sm"/>
                    <div class="has-error">
	...
	<div class="row">
            <div class="form-group col-md-12">
               ...
               <div class="col-md-6">
                    <form:input type="text" path="brief" id="brief" class="form-control input-sm"/>
                    <div class="has-error">
